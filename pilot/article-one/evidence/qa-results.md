...
- Vercel Preview deployment: PASS. Anonymous route smoke initially hit Deployment Protection/Auth0; a temporary Vercel share URL then enabled read-only verification. All 6 desktop/mobile route checks passed with HTTP 200, correct merchant identity, frame count, Reference marker, and zero console/page errors.
