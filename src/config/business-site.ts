...
export const businessPages: Record<BusinessPageKey, BusinessPageDefinition> = {
  ...
  pricing: {
    ...
    title: 'Choose the right capacity for your next stage of eyewear commerce.',
    description: 'Start Free, validate a real catalog with the Founding Pilot, or choose recurring capacity for growing Store and Campaign journeys.',
    primaryCta: { label: 'Start a Pilot', href: pilotHref },
    secondaryCta: { label: 'Contact Sales', href: '/business/pilot?plan=enterprise' },
    sections: [],
  },
  examples: {
