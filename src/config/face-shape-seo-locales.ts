...
const copies: Record<Locale, FaceShapeSeoCopy> = {
  en: {
    ...
    detector: {
      metaTitle: 'Face Shape Detector for Glasses — Free, Private, On-Device', metaDescription: 'Free face shape detector for glasses. Upload one photo in your browser—no login, credits, or photo upload to VisuTry—then continue to personalized frame recommendations and virtual try-on.', badge: 'Free · No login · On-device', title: 'Free Face Shape Detector for Glasses', intro: 'Find whether your face is oval, round, square, heart, diamond, oblong, or triangle. Use the result to shortlist glasses, then validate frames on your own photo.',
