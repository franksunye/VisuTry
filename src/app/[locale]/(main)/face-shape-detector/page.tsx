...
export default function FaceShapeDetectorPage({ params }: FaceShapeDetectorPageProps) {
  ...
  const howToSchema = generateStructuredData('howTo', {
    ...
    steps: [
      ...
      { name: 'Review the estimate', text: 'See the landmark mesh, likely shape, measured ratios, photo alignment, and next-step tools.' },
    ],
  })
        ...
        <section className="mx-auto max-w-6xl px-4 py-10 md:py-14">
          <div className="mx-auto mb-9 max-w-4xl text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg leading-8 text-gray-600">
              ...
              triangle. See the landmark mesh and measured proportions without sending your photo
              to VisuTry or using a Gemini request.
            </p>
          </div>
