...
- **Measure:** the current PR head is deployed to a Vercel preview equivalent
  (`dpl_DFhwoDZRHp2YPKNAyj3S8V1QrEHB`). Production `visutry.com` Store/Campaign
...
| Action | Deployed PR head `ef6d881` to Vercel preview `dpl_DFhwoDZRHp2YPKNAyj3S8V1QrEHB`; verified production `visutry.com` and preview Store/Campaign routes; added `report:agent-distribution`. |
