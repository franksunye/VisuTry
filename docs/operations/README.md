...
| `cloudflare-b4-2c-phase-a-dns-zone.md` | **Active milestone** | B4.2C Phase A: freeze Vercel www origin, DNS inventory, inactive-zone desired state (no NS change / no traffic cutover) |
